...
def encode_image_tuple_qrac_3(img1, img2, img3):
    ...
    qubits = [cirq.GridQubit(0, j) for j in range(12)]
...
datafname = 'reduced_dataset_12pixels_V1.npz'
...
datafname = 'reduced_dataset_12pixels_V3.npz'
print(f"Loading data from {datafname}...")
data = np.load(datafname)
X3 = data['images']
y3 = data['labels']
...
# export history
fname = f"sum_2_4x3_9_qubit_bs{batch_size}_Ntuples{num_tuples}_Nh{N_shot}_Nl{num_layers}_QRACV1V2V3.dat"
export_history(history, fname)
fname = f"sum_2_4x3_9_qubit_bs{batch_size}_Ntuples{num_tuples}_Nh{N_shot}_Nl{num_layers}_QRACV1V2V3.h5"
